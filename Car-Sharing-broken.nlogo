globals
[
  rural-to-urban ;(1-100?)
  car-sharing-type ;round, floating, station, fractional
  rides
  x
  xx
]
...
to move-toward [y] ;person procedure
  face y
  if breed = "car"
  [
    fd 5
...
to accept-passenger [ person ] ;car procedure
  set traveling true
  set traveler person
  set full true

  if strategy = "round" or strategy = "floating"
  [
    set destination [ destination ] of traveler
  ]
  if strategy = "station"
  [
...
to end-ride [ next-step ] ;car procedure
  set rides rides + 1
  ...
  [
    ...
    set selected-car nobody
    set in-car false
    set destination next-step
  ]

  set traveler nobody
end

;if close to the traveler, move to it and accept traveler
;otherwise move toward traveler
to self-driving-movement ;car procedure
  if traveler != nobody and not traveling
  [
    ifelse distance traveler < 5
    [
      move-to traveler
      accept-passenger traveler
    ]
    [
      move-toward traveler
    ]
  ]
end

to travel-round ;car-procedure
...
to travel-floating ;car-procedure
  ifelse distance destination < 5
  [
    move-to destination
    ...
    ifelse [ pcolor ] of patch-here != yellow
    [
      end-ride [ destination ] of traveler
    ]
    [
      set traveling false
...
to travel-station ;car-procedure
  move-toward destination
...
;;;;;;;;;;;;;;;;;;;;;;;;;running cars vs running people divide ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    [
      ...
      [
        ...
        [
            ...
            [
              ...
              [
                ...
                [
                  ifelse self-driving
                  [
                    if [traveler] of find-car = nobody
                    [
          ...
          ifelse selected-car = 0
          [
            move-toward destination
            check-arrival
          ]
          [
            ifelse [ full ] of selected-car = false
            [
              move-toward selected-car
